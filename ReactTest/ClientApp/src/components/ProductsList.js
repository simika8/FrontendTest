...
export default class ProductsList extends React.Component {
    ...
    componentDidUpdate() {
        ...
        if (this.cursorRef.current) {
            this.cursorRef.current.scrollIntoView({ behavior: "auto", block: "center" });
        }
    ...
    productList(cursorRef) {
        ...
        let a = this.state.products.map(function (currentProduct, i) {
    ...
    handleKeyDown = (event) => {
        ...
        if (this.cursorRef.current) {
            //this.cursorRef.current.scrollIntoView({ behavior: "auto", block: "nearest" });
        }
