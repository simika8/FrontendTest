...
export default class ProductsList extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            productsMinTimeoutMs: params.get("productsMinTimeoutMs") || 0,
            productsMaxTimeoutMs: params.get("productsMaxTimeoutMs") || 0,
            /*productsMinTimeoutMs:  0,
            productsMaxTimeoutMs:  0,*/
            cursor: 0,
        };
        console.log(this.state.productsMinTimeoutMs+ " " +this.state.productsMaxTimeoutMs);
    ...
    refilter(searchfilter) {
        ...
        if (searchfilter) {
            axios.get("https://localhost:44339/api/Products?keyword=" + searchfilter + "&take=30&minTimeoutMs=" + this.state.productsMinTimeoutMs + "&maxTimeoutMs=" + this.state.productsMaxTimeoutMs)
            //axios.get("https://localhost:44339/api/Products?keyword=" + searchfilter + "&take=30&minTimeoutMs=0&maxTimeoutMs=0")
                .then(response => {
